# Context:
This was our hackathon project goal. This repo is just one part (first phase to finalize the idea). Other repos are not connected/synced yet.
**Also, this project was largely vibe coded — thanks to ChatGPT 🙂**


# TruLens -- Why LLMS recommend the product they recommend?
